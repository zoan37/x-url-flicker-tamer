...
Stops the address bar flickering between a post URL and x.com while the page loads. Runs only on x.com; collects no data.
...
- ZIP: dist/url-flicker-tamer-1.0.0.zip (contains manifest.json, tamer.js,
